...
public class AvailableDoctorsController {
    ...
    @FXML
    public Button searchButton;  // Bouton de recherche

    @FXML
    public ListView<String> availabilityListView;  // Liste des médecins disponibles

    @FXML
    public DatePicker datePicker;  // Sélecteur de date

    //@FXML
    //public TextField specialtyTextField;  // Champ pour la spécialité (facultatif)

    @FXML
    public ComboBox<String> specialtyComboBox; // Champ pour la spécialité (facultatif)
    ...
    public void displayDoctorsAvailableOnDate(LocalDate selectedDate, String specialty) {
