...
public class MedicationFormController {
    ...
    @FXML
    public ComboBox<String> combo_pharmacy;

    @FXML
    public ComboBox<String> medicamentsComboBox;

    @FXML
    public TableView<String> medicamentsTableView;

    @FXML
    public TableColumn<String, String> medicamentColumn;
    ...
    public Map<String, Integer> pharmacyMap = new HashMap<>();
    public Map<String, Integer> medicationMap = new HashMap<>();
    ...
    @FXML
    public void handleAddMedicamentAction() {
