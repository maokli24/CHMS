...
public class PostponeAppointmentController {
    ...
    public PostponeCallback callback;
    ...
    @FXML
    public Label current_appointment_date;

    @FXML
    public Label doctor_label;

    @FXML
    public DatePicker new_date;

    @FXML
    public Label patient_label;

    @FXML
    public ComboBox<String> new_doctor;

    @FXML
    public ComboBox<String> new_time;
    ...
    public void configureTimeComboBox() {
    ...
    public void showConfirmationMessage(String message, Stage currentStage) {
