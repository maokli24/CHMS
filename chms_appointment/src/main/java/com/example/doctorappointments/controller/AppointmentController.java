...
public class AppointmentController {
    ...
    @FXML
    public TableView<AppointmentDetails> AppointmentTableView;

    @FXML
    public TableColumn<AppointmentDetails, String> PatientNameTableColumn;
    @FXML
    public TableColumn<AppointmentDetails, String> DoctorNameTableColumn;
    @FXML
    public TableColumn<AppointmentDetails, String> AppointmentDateTableColumn;
    @FXML
    public TableColumn<AppointmentDetails, String> AppointmentTimeTableColumn;
    @FXML
    public TableColumn<AppointmentDetails, String> ServiceTableColumn;
    @FXML
    public TableColumn<AppointmentDetails, String> StatusTableColumn;
    @FXML
    public TableColumn<AppointmentDetails, String> PayeTableColumn;

    @FXML
    public TableColumn<AppointmentDetails, Void> ActionsTableColumn;



    @FXML
    public TextField SearchFieldText;
    ...
    public ObservableList<AppointmentDetails> appointments;
    ...
    public void initialize() {
        ...
        ActionsTableColumn.setCellFactory(param -> new TableCell<AppointmentDetails, Void>() {
            public final Button ordonnanceTestButton = new Button("Ordonnance Test");
            public final Button ordonnanceVisiteButton = new Button("Ordonnance Visite");
            public final Button reporterButton = new Button("Reschedule");
            public final Button annulerButton = new Button("Cancel");
...
//                        hBox.setAlignment(Pos.CENTER);
    ...
    public void updateTableView(SortedList<AppointmentDetails> sortedAppointments, int pageIndex) {
...
//    public void updatePagination(FilteredList<AppointmentDetails> filteredAppointments) {
...
//    }
    ...
    public void handleOrdonnanceTest(AppointmentDetails appointment) {
    ...
    public void handleOrdonnanceVisite(AppointmentDetails appointment) {
    ...
    public void handleReporter(AppointmentDetails appointment) {
    ...
    public void handleAnnuler(AppointmentDetails appointment, Button ordonnanceTestButton, Button ordonnanceVisiteButton, Button reporterButton, Button annulerButton) {
    ...
    public void checkAndUpdateStatus(AppointmentDetails appointment) {
    ...
    public void updateButtonStates(AppointmentDetails appointment, Button ordonnanceTestButton, Button ordonnanceVisiteButton, Button reporterButton, Button annulerButton) {
